...
class Sprite {
    constructor({ position, velocity }) {/*position independent of one another. wrapping in an object makes u pass through one argument instead of two cat pass through velocity first*/
    ...
    moveSprite() {
        ...
        if (this.position.y + this.height + this.velocity.y >= canvasElement.height) {
            this.velocity.y = 0
